...
Compile a simple SELECT benchmark with `github.com/mattn/go-oci8` and `github.com/sergeantwolf/ora`, and compare them:
...
(pprof) :tgulacsi@tgulacsi-laptop: ~/src/github.com/sergeantwolf/ora/examples/bench
```
